...
//?antes tenía hecho ésto y en los spread operators usaba las variables alienCucu y mutPorom.
// let alienCucu;
// let mutPorom;
// alienCucu = aliens.find((alien) => alien.name == "Cucushumushu");
// console.log(alienCucu);
// mutPorom = mutations.find((mutation) => mutation.name == "Porompompero");
// console.log(mutPorom);
const megaAlien = {
