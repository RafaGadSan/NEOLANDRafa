...
//?HAY ALGUNA MANERA DE HACER const copiaColors = [...colors].splice(2, 1); Y QUE NO ME ALMACENE SOLO LA POSICIÓN 2?

const copiaColors = [...colors];
copiaColors.splice(2, 1);
console.log(
  `El array original es ${colors}\nEl array modificado es ${copiaColors}`
);
